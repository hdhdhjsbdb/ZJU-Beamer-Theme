...
\author{杨宁}
\title{ZJU Beamer Theme}
\subtitle{基于ZJU Beamer Theme的美化与使用示例}
\institute{浙江大学机械工程学院}
\date{2026年3月27日}
\usepackage{ZJU}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/浙江大学-logo.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item GitHub项目地址位于 \url{https://github.com/Trinkle23897/ZJU-Beamer-Theme}，如果有bug或者feature request可以去里面提issue
    \end{itemize}
\end{frame}
...
\begin{frame}{这一份主题与原始的ZJU Beamer Theme区别在于}
    \begin{itemize}
        \item 顶栏的小点变成一行而不是多行
        \item 中文采用楷书
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.3\linewidth]{pic/浙江大学-logo.pdf}
        \caption{这里使用浙江大学校徽图片}
    \end{figure}
\end{frame}
